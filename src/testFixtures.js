export const books = [
  ...
  },
  {
    ...
    imageLinks: {
      thumbnail:
        "http://books.google.com/books/content?id=EDOVAT808fUC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
      smallThumbnail:
        "http://books.google.com/books/content?id=EDOVAT808fUC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api"
    },
    pageCount: 408,
    publishedDate: "1997",
    ...
    ratingsCount: 1,
    shelf: "wantToRead",
    subtitle: "Travel and Translation in the Late Twentieth Century",
    title: "Routes"
  }
];
